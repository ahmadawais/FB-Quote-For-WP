<?php
/**
 * Main Class file for `WP_OSA_FBQ`
 *
...
class WP_OSA_FBQ {
	...
	public function admin_menu() {
	    ...
	    add_options_page( 'FB Quotes', 'FB Quotes', 'manage_options', 'fb_quotes_settings', array( $this, 'plugin_page' ) );

	}

	public function plugin_page() {
	    echo '<div class="wrap">';
	    	echo '<h1>Facebook Quote Plugin for WP <span style="font-size:50%;">v' . FBQ_VERSION . '</span></h1>';
